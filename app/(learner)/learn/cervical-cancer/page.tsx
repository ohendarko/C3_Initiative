...
const handleLogout = async () => {
  ...
  return <div className="text-red-500 text-center mt-10">Failed to load modules. Please try again later.</div>
   ...
   const jsonLd = {
    ...
    '@type': 'Course',
    name: 'Cervical Cancer Education',
    description: 'Comprehensive cervical cancer education covering prevention, screening, and treatment',
    provider: {
      '@type': 'Organization',
      name: 'C3 Initiative',
      sameAs: 'https://c3-learning.com',
    },
